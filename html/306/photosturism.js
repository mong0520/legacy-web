...
foldersTree=gFld("<font size=2 color=#6666FF>主 選 單</font>","")
 ...
 aux1 = insFld(foldersTree, gFld("<font size=2>尋人服務</font>", "left.htm#"))
  ...
  insDoc(aux1, gLnk(2,"跨 年","year_index.htm" ))
  insDoc(aux1, gLnk(2,"同學會(舊)","classmate.htm" ))
  insDoc(aux1, gLnk(2,"同學會投票","vote1.htm" ))
  insDoc(aux1, gLnk(2,"同學會(新)","2002/index.htm" ))
  
 aux1 = insFld(foldersTree, gFld("<font size=2>聯   絡   簿</font>", "left.htm#"))
insDoc(aux1, gLnk(2,"留 言 板","http://doing.net/free/fgb/fgb.php3?user=mong" ))
insDoc(aux1, gLnk(1,"備 用 板","http://gb.hiweb.com/afgb.php?A=a259-mong" ))
