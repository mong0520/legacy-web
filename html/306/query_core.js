...
Show_Msg=(NotFound)?"找不到相關資料！":"共搜尋到 <font color=\"#3377ee\">"+j+"</font> 筆資料。"
Last_Str=Curr_Str
}
showResultPage(p)
...
write(escape("<td>您輸入的關鍵字「 <font color=\"#3377ee\">"+Curr_Str+"</font> 」"+Show_Msg+"</td>"))
if(!NotFound){
...
write(escape("<option value=\""+i+"\""+s+"&nbsp;第 "+i+" 頁&nbsp;"))
}
...
write(escape("頁次：<font face=\"verdana\"><b>"))
for(i=1;i<=Page_Cnt;i++){
